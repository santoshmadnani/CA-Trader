...
ssh_cmd = [
    ...
    '-o', 'StrictHostKeyChecking=no',
    HOST,
    'sudo /home/ubuntu/deploy.sh 40.zip'
]
...
print('\n=== Release 40 Deployment Complete ===')
