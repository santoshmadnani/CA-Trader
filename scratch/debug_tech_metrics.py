...
print("TECHNICAL KEYS COUNT:", len(tech))
for k in ["supertrend", "supertrend_direction", "vwap", "rsi", "adx", "adx_strength", "atr", "pivot_high", "pivot_low", "breakout", "signal", "score"]:
    print(f"  {k}: {tech.get(k)}")
"""
