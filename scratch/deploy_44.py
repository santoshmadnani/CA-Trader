#!/usr/bin/env python3
"""Deploy Release 44 (Refined Base 42 with All Punchlist Fixes) to production."""
...
ZIP_PATH = pathlib.Path(r'c:\Users\SantoshMadnani\Documents\CA_Trader\44.zip')
...
print('=== Release 44 Production Deployment ===')

# Step 1: Package 44.zip
...
print(f'\n[2/4] Uploading to {HOST}:/home/ubuntu/44.zip ...')
scp_cmd = [
    'scp', '-i', KEY,
    '-o', 'StrictHostKeyChecking=no',
    '-o', 'BatchMode=yes',
    str(ZIP_PATH),
    f'{HOST}:/home/ubuntu/44.zip'
]
...
print(f'\n[3/4] Running deploy script on remote server (deploy.sh 44.zip) ...')
ssh_cmd = [
    'ssh', '-i', KEY,
    '-o', 'StrictHostKeyChecking=no',
    '-o', 'BatchMode=yes',
    HOST,
    'sudo /home/ubuntu/deploy.sh 44.zip'
]
