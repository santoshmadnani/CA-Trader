...
zip_path = r"c:\Users\SantoshMadnani\Documents\CA_Trader\30.zip"
...
print("1. Creating 30.zip for Release 30...")
...
print(f"30.zip created! Size: {os.path.getsize(zip_path)} bytes")

print("\n2. Uploading 30.zip to server (15.252.81.122)...")
res = subprocess.run([
    "scp", "-i", ssh_key,
    "-o", "StrictHostKeyChecking=no",
    "-o", "BatchMode=yes",
    zip_path, f"{remote_host}:/home/ubuntu/30.zip"
...
print("\n3. Running deploy.sh 30.zip on server...")
dp = subprocess.run([
    "ssh", "-n", "-i", ssh_key,
    "-o", "StrictHostKeyChecking=no",
    "-o", "BatchMode=yes",
    remote_host,
    "sudo /home/ubuntu/deploy.sh 30.zip"
