...
ssh_cmd = [
    ...
    '-o', 'StrictHostKeyChecking=no',
    HOST,
    'sudo /home/ubuntu/deploy.sh 36.zip'
]
...
print('\n=== Release 36 Deployment Complete ===')
