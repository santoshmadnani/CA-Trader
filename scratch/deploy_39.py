...
ssh_cmd = [
    ...
    '-o', 'StrictHostKeyChecking=no',
    HOST,
    'sudo /home/ubuntu/deploy.sh 39.zip'
]
...
print('\n=== Release 39 Deployment Complete ===')
