...
ssh_cmd = [
    ...
    '-o', 'StrictHostKeyChecking=no',
    HOST,
    'sudo /home/ubuntu/deploy.sh 38.zip'
]
...
print('\n=== Release 38 Deployment Complete ===')
