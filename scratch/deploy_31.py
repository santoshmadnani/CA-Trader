...
zip_path = r"c:\Users\SantoshMadnani\Documents\CA_Trader\31.zip"
...
print("1. Creating 31.zip for Release 31...")
...
print(f"31.zip created! Size: {os.path.getsize(zip_path)} bytes")

print("\n2. Uploading 31.zip to server (15.252.81.122)...")
res = subprocess.run([
    "scp", "-i", ssh_key,
    "-o", "StrictHostKeyChecking=no",
    "-o", "BatchMode=yes",
    zip_path, f"{remote_host}:/home/ubuntu/31.zip"
...
print("\n3. Running deploy.sh 31.zip on server...")
dp = subprocess.run([
    "ssh", "-n", "-i", ssh_key,
    "-o", "StrictHostKeyChecking=no",
    "-o", "BatchMode=yes",
    remote_host,
    "sudo /home/ubuntu/deploy.sh 31.zip"
