...
ssh_cmd = [
    ...
    '-o', 'StrictHostKeyChecking=no',
    HOST,
    'sudo /home/ubuntu/deploy.sh 37.zip'
]
...
print('\n=== Release 37 Deployment Complete ===')
