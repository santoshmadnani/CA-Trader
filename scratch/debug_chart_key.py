...
# Test chart bundle with NSE_INDEX|Nifty 50 or instrument key
r_chart = s.get("http://127.0.0.1:8000/api/analysis/chart-bundle/NSE_INDEX%7CNifty%2050?timeframe=5m").json()
print("CHART CANDLES COUNT:", r_chart.get("candles_used"))
print("CHART TECH:", json.dumps(r_chart.get("technical"), indent=2))
"""
