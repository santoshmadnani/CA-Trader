#!/usr/bin/env python3
"""Deploy Release 45 (Resolving all 23 live feedback items) to production."""
...
ZIP_PATH = pathlib.Path(r'c:\Users\SantoshMadnani\Documents\CA_Trader\45.zip')
...
print('=== Release 45 Production Deployment ===')

# Step 1: Package 45.zip
...
print(f'\n[2/4] Uploading to {HOST}:/home/ubuntu/45.zip ...')
scp_cmd = [
    'scp', '-i', KEY,
    '-o', 'StrictHostKeyChecking=no',
    '-o', 'BatchMode=yes',
    str(ZIP_PATH),
    f'{HOST}:/home/ubuntu/45.zip'
]
...
print(f'\n[3/4] Running deploy script on remote server (deploy.sh 45.zip) ...')
ssh_cmd = [
    'ssh', '-i', KEY,
    '-o', 'StrictHostKeyChecking=no',
    '-o', 'BatchMode=yes',
    HOST,
    'sudo /home/ubuntu/deploy.sh 45.zip'
]
...
print('\n=== Release 45 Deployment Complete and Verified! ===')
