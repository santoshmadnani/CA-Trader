...
zip_path = r"c:\Users\SantoshMadnani\Documents\CA_Trader\32.zip"
...
print("1. Creating 32.zip for Release 32...")
...
print(f"32.zip created! Size: {os.path.getsize(zip_path)} bytes")

print("\n2. Uploading 32.zip to server (15.252.81.122)...")
res = subprocess.run([
    "scp", "-i", ssh_key,
    "-o", "StrictHostKeyChecking=no",
    "-o", "BatchMode=yes",
    zip_path, f"{remote_host}:/home/ubuntu/32.zip"
...
print("\n3. Running deploy.sh 32.zip on server...")
dp = subprocess.run([
    "ssh", "-n", "-i", ssh_key,
    "-o", "StrictHostKeyChecking=no",
    "-o", "BatchMode=yes",
    remote_host,
    "sudo /home/ubuntu/deploy.sh 32.zip"
